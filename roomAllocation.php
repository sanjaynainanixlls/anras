                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <form role="form" action="action/action.php" method="post">
                                ...
                                <div class="form-group">
                                    <label>City</label>
                                    <input type="text"  class="form-control" name="city" value="<?php if (isset($data['city'])) echo $data['city']; ?>" required="required">
                                </div>

                                <div class="form-group">
                                    <label>Mobile Number</label>
                                    <input type="tel"  class="form-control" name="phoneNumber" value="<?php if (isset($data['phoneNumber'])) echo $data['phoneNumber']; ?>" required="required">
                                </div>

                                <div class="form-group">
                                    <label>Total Number of Bhagats</label>
                                    <input type="number" class="form-control" id="numberOfPeople" name="numberOfPeople" value="<?php if (isset($data['numberOfPeople'])) echo $data['numberOfPeople']; ?>" required="required">
                                </div>

                                <div class="form-group">
                                    <label>Date of Arrival</label>
                                    <input id="comingDate" type="date" class="form-control" name="comingDate" value="<?php if (isset($data['dateOfArrival'])) echo $data['dateOfArrival']; ?>" required="required">
                                </div>

                                <div class="form-group">
                                    <label>Date of Return</label>
                                    <input type="date" class="form-control" name="returnDate" value="<?php if (isset($data['dateOfDeparture'])) echo $data['dateOfDeparture']; ?>" required="required">
                                </div>
