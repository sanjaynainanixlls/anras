    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
				<form action="DoTodaysCheckouts" method="post">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-hover" id="completeStatusTable">
                                ...
                                <tbody>
                                <%List notCheckedOut =  (List) request.getAttribute("notCheckoutedOut");
                                %>
                                    <%  for (Iterator iterator = 
                                    		notCheckedOut.iterator(); iterator.hasNext();){
             User user = (User) iterator.next(); 
             %>
             <tr>
             <td><input type="checkbox" name="idCheckboxes" value="<%= user.getId()  %>" checked="checked"></td>
             <td><%= user.getId()  %></td>
             <td><%= user.getName() %></td>
             <td><%= user.getPhoneNumber() %></td>
             <td><%= user.getCity() %></td>
             <td><%= user.getComingDate() %></td>
             <td><%= user.getReturnDate() %></td>
             <td><%= user.getNumberOfPeople() %></td>
             <td><%= user.getRoomAlloted() %></td>
             </tr>
             <%
          }
          %>
