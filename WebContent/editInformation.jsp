    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
						<%User userToBeEdited = (User)request.getAttribute("userToBeEdited"); %>
                        <form role="form" action="EditThisUser" method="post">
						
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text"  class="form-control" name="name" required="required" value="<%=userToBeEdited.getName()%>">
                            </div>

                            <div class="form-group">
                                <label>City</label>
                                <input type="text"  class="form-control" name="city" required="required" value="<%=userToBeEdited.getCity()%>">
                            </div>
                            
                            <div class="form-group">
                                <label>Mobile Number</label>
                                <input type="tel"  class="form-control" name="phoneNumber" required="required" value="<%=userToBeEdited.getPhoneNumber()%>">
                            </div>
                            
                            <div class="form-group">
                                <label>Total Number of Bhagats</label>
                                <input type="number" class="form-control" name="numberOfPeople" required="required" value="<%=userToBeEdited.getNumberOfPeople()%>">
                            </div>
 							
 							<div class="form-group">
                                <label>Date of Arrival</label>
                                <input id="comingDate" type="date" class="form-control" name="comingDate" required="required" value="<%=userToBeEdited.getComingDate()%>">
                            </div>
 							                           
                            <div class="form-group">
                                <label>Date of Return</label>
                                <input type="date" class="form-control" name="returnDate" required="required" value="<%=userToBeEdited.getReturnDate()%>">
                            </div>
                            ...
                            <div class="form-group">
                            	...
                            	<input name="userIdToBeEdited" id="roomNumberAlloted" type="hidden" value="<%=userToBeEdited.getId() %>" readonly="readonly">
