    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="roomStatusTable">
                                ...
                                <tbody>
                                <%List roomStatus =  (List) request.getAttribute("roomStatus");%>
                                    <%  for (Iterator iterator = 
                                    		roomStatus.iterator(); iterator.hasNext();){
             ...
             <td class="roomNumberClass"><strong><%= room.getRoomNumber()%></strong></td>
             <td class="roomCapacityClass"><strong><%= room.getCapacity() %></strong></td>
             <td class="numberOfPeopleStayingClass"><strong><%= room.getNumberOfPeopleStaying() %></strong></td>
             <td class="cities"><strong><%= room.getCityString()%></strong></td>
             </tr>
             <%
          }%>
                                </tbody>
